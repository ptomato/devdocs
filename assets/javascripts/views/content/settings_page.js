app.views.SettingsPage = class SettingsPage extends app.View {
  ...
  static initClass() {
    this.LAYOUTS = ['_max-width', '_sidebar-hidden', '_native-scrollbars'];
    this.SIDEBAR_HIDDEN_LAYOUT = '_sidebar-hidden';
  ...
  currentSettings() {
    ...
    for (let layout of SettingsPage.LAYOUTS) {
  ...
  toggleLayout(layout, enable) {
    if (layout !== SettingsPage.SIDEBAR_HIDDEN_LAYOUT) {
